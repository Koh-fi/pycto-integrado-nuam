...
- [x] Terminar de desarrollar los templates (FrontEnd) basado exclusivamente en la página oficial de nuam.
- [x] Desarrollar Models basados en los diagramas.
- [x] Desarrollar Forms basados en los diagramas.
- [x] Desarrollar página de Login.
- [x] Templates de Intranet (3 templates)
...
- [ ] Terminar de Desarrollar Templates
   ...
   - [ ] Desarrollar Templates de Actualizaciones
...
- [0] Desarrollar más a fondo Sistemas de Login
   ...
   - [ ] Gestionar otro tipo de errores e intentos de acceso restringido mediante vistas
  
   - [ ] Gestionar permisos de usuario mediante Django.
